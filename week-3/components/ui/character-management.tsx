...
interface Character {
  ...
  description: string
  personality: string
  role?: string // Optional role in the story
}
              ...
              <TableBody>
                {characters.map((character) => (
                  <TableRow key={character.id}>
                    ...
                    <TableCell>{character.role && <Badge variant="outline">{character.role}</Badge>}</TableCell>
                    <TableCell>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <Button onClick={handleGenerateStory} disabled={isGenerating || characters.length === 0}>
